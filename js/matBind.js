...
bind(10,'tap','changeFormula("\\\\color{yellow}\\\\times")');
bind(10,'press','changeFormula("\\\\mathrm{e}")');
bind(11,'tap','changeFormula("\\\\color{yellow}\\\\cdot")');
bind(11,'press','changeFormula("\\\\log(")');
bind(12,'tap','changeFormula("Det(")');
bind(12,'press','changeFormula("\\\\arcsin(")');
bind(13,'tap','changeFormula("Eigen(")');
bind(13,'press','changeFormula("\\\\arccos(")');
bind(14,'tap','changeFormula("Crr(")'); 
bind(14,'press','changeFormula("\\\\arctan(")');
bind(15,'tap','changeFormula("Inv(")');
bind(15,'press','changeFormula("^{-1}")');
bind(16,'tap','changeFormula("Tr(")');
...
bind(33,'tap','changeFormula("Res")');
bind(33,'press','changeFormula("\\\\color{pink}M")');
