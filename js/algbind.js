...
bind(12,'tap','changeFormula("\\\\sin(")');
bind(12,'press','changeFormula("\\\\arcsin(")');
bind(13,'tap','changeFormula("\\\\cos(")');
bind(13,'press','changeFormula("\\\\arccos(")');
bind(14,'tap','changeFormula("\\\\tan(")'); 
...
bind(110,'tap','changeFormula("{\\\\lim\\\\limits_{x \\\\to \\\\underline{}}}(",{leftMove:4})');
bind(111,'tap','changeFormula("{\\\\lim\\\\limits_{x \\\\to +\\\\infty}}(")');
bind(112,'tap','changeFormula("{\\\\lim\\\\limits_{x \\\\to -\\\\infty}}(")');
